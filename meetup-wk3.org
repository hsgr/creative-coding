...
In Pure Data you have to install [[http://en.flossmanuals.net/pure-data/network-data/osc/][mrpeach]] for OSC communication.  In SuperCollider check the help file [[http://doc.sccode.org/Guides/OSC_communication.html][OSC communication]].
